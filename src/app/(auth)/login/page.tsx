    ...
    try {
      ...
      if (error.code === 'auth/unauthorized-domain') {
        ...
        toast({
          ...
          description: (
            <div className="mt-2 space-y-2 text-left">
              <p>La ventana se cerró. Si no la cerraste tú, verifica que este dominio esté autorizado en Firebase:</p>
              <code className="block bg-secondary p-2 rounded text-[10px] break-all font-mono select-all">
                {hostname}
              </code>
              <p className="text-xs">También verifica que no tengas un bloqueador de ventanas emergentes.</p>
            </div>
          ),
          variant: "destructive",
          duration: 10000,
